...
The MinBy and MaxBy operators allow you to partition your sequence based on a key selector function. Key selector functions are common in other LINQ operators like the IEnumerable<T>ToDictionary or GroupBy and the [Distinct](http://www.introtorx.com/Content/v1.0.10621.0/05_Filtering.html#Distinct) TODO method. Each method will return you the values from the key that was the minimum or maximum respectively.
