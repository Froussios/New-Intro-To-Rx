...
Our next example comes from the [blog post](http://blogs.msdn.com/b/rxteam/archive/2012/03/12/reactive-extensions-v2-0-beta-available-now.aspx) that introduced Rx 2.0. First consider a recursive solution to generating a range of numbers:
